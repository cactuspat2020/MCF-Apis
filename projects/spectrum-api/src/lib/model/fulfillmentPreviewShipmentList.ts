...
/**
 * A comma-delimited list of fulfillment preview shipment information.
 */
export interface FulfillmentPreviewShipmentList extends Array<FulfillmentPreviewShipment> { 
}