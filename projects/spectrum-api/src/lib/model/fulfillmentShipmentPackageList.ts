...
/**
 * A comma-delimited list of fulfillment shipment package information.
 */
export interface FulfillmentShipmentPackageList extends Array<FulfillmentShipmentPackage> { 
}