 ...
 */
import { GetFulfillmentPreviewItem } from './getFulfillmentPreviewItem';

/**
 * A comma-delimited list of fulfillment preview item information.
 */
export interface GetFulfillmentPreviewItemList extends Array<GetFulfillmentPreviewItem> { 
}